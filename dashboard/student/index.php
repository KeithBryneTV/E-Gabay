...
// Require student login with strict validation
requireRole(['student']);
...
$query = "SELECT 
          ...
          SUM(CASE WHEN status = 'live' AND NOT EXISTS (
              SELECT 1 FROM chat_sessions cs 
              WHERE cs.consultation_id = consultation_requests.id AND cs.status = 'closed'
          ) THEN 1 ELSE 0 END) as active_consultations,
...
$query = "SELECT cr.*, 
          ...
          (SELECT COUNT(*) FROM chat_sessions cs WHERE cs.consultation_id = cr.id AND cs.status = 'closed') as has_closed_chat
...
// Get unread messages count from utility function
$unread_count = getUnreadMessageAndConsultationCount($user_id);
...
<style>
/* Modern Dashboard Card Styles - Same as Admin & Counselor */
.modern-card {
    ...
    <div class="quick-actions-body">
        <div class="row g-3">
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/request_consultation.php" class="action-btn action-btn-primary w-100">
                    <i class="fas fa-plus-circle"></i>
                    Request Consultation
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/consultations.php" class="action-btn action-btn-success w-100">
                    <i class="fas fa-clipboard-list"></i>
                    My Consultations
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/messages.php" class="action-btn action-btn-warning w-100">
...
<div class="row mb-4">
    <div class="col-md-3 mb-3">
        <div class="modern-card card-primary h-100">
            ...
            <div class="modern-footer">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/consultations.php">
    ...
    <div class="col-md-3 mb-3">
        <div class="modern-card card-success h-100">
            ...
            <div class="modern-footer">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/consultations.php?status=live">
                    View Details <i class="fas fa-chevron-right ms-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="modern-card card-warning h-100">
            ...
            <div class="modern-footer">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/consultations.php?status=pending">
                    View Details <i class="fas fa-chevron-right ms-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-md-3 mb-3">
        <div class="modern-card card-info h-100">
            ...
            <div class="modern-footer">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/messages.php">
        ...
        <div class="chart-card">
            ...
            <div class="card-body">
                <?php if (empty($recent_consultations)): ?>
                    <p class="text-center">You haven't requested any consultations yet.</p>
                <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($recent_consultations as $consultation): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($consultation['has_closed_chat'] > 0) {
            ...
            <div class="card-footer text-end">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/consultations.php" class="btn btn-primary">View All</a>
            </div>
        </div>
    </div>
        ...
        <div class="chart-card">
            ...
            <div class="card-body">
                <?php if (empty($active_chats)): ?>
                    <p class="text-center">You don't have any active chat sessions.</p>
                <?php else: ?>
                    <div class="list-group">
                        <?php foreach ($active_chats as $chat): ?>
                            <a href="<?php echo SITE_URL; ?>/dashboard/student/chat.php?id=<?php echo $chat['id']; ?>" class="list-group-item list-group-item-action">
                                <div class="d-flex w-100 justify-content-between">
                                    <h6 class="mb-1"><?php echo $chat['subject']; ?></h6>
                                    <?php if ($chat['unread_count'] > 0): ?>
                                        <span class="badge bg-danger"><?php echo $chat['unread_count']; ?> new</span>
                                    <?php endif; ?>
                                </div>
                                <p class="mb-1">Counselor: <?php echo $chat['counselor_first_name'] . ' ' . $chat['counselor_last_name']; ?></p>
                                <small class="text-muted">Last activity: <?php echo formatDate($chat['updated_at'], 'M d, Y h:i A'); ?></small>
                            </a>
                        <?php endforeach; ?>
                    </div>
                <?php endif; ?>
            ...
            <div class="card-footer text-end">
                <a href="<?php echo SITE_URL; ?>/dashboard/student/messages.php" class="btn btn-primary">View All Messages</a>
            </div>
        </div>
    </div>
</div>
