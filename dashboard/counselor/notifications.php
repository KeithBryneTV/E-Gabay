...
$page_title = 'Counselor Notifications';
...
// Clear (delete) a single notification if requested
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="notification-page-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">
                        <i class="fas fa-bell me-2"></i> Counselor Notifications
                    </h5>
                    <?php if (!empty($notifications)): ?>
                    <div class="btn-group">
                        <a href="<?php echo SITE_URL; ?>/dashboard/counselor/notifications.php?mark_all_read=1" class="btn btn-light btn-sm">
                            <i class="fas fa-check-double me-1"></i> Mark All as Read
                        </a>
                        <a href="<?php echo SITE_URL; ?>/dashboard/counselor/notifications.php?clear_all=1" class="btn btn-danger btn-sm">
